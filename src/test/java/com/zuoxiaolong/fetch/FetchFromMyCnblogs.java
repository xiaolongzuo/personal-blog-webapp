...
public class FetchFromMyCnblogs {
    ...
    private static void fetchArticles() throws IOException {
        ...
        for (int i = 1; i < 15; i++) {
            ...
            for (Element element : elements) {
                fetchArticle(fileWriter, element);
                pageSize++;
            }
    ...
    private static void fetchArticle(FileWriter fileWriter, Element element) throws IOException {
